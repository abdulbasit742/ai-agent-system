        ...
        self.assertEqual(
            {
                ...
                "agent-audit-trust-bundle", "agent-changed-lines", "agent-system",
                "basit-agent", "basit-agent-audit-admission", "basit-agent-audit-bundle",
                ...
                "basit-agent-catalog-consistency", "basit-agent-lines",
