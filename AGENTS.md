...
These instructions apply to the entire `abdulbasit742/ai-agent-system` repository. This repository is currently a bootstrap/empty project, so do not assume a language, framework, package manager, deployment target, or architecture.
